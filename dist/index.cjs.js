      ...
      var nodeDropTarget = {
        ...
        hover: function hover(dropTargetProps, monitor, component) {
          ...
          _this2.rafId = requestAnimationFrame(function () {
            var _monitor$getItem2;

            _this2.dragHover({
              node: draggedNode,
              path: (_monitor$getItem2 = monitor.getItem()) === null || _monitor$getItem2 === void 0 ? void 0 : _monitor$getItem2.path,
              minimumTreeIndex: dropTargetProps.listIndex,
              depth: targetDepth
            });
          });
...
var ReactSortableTree = /*#__PURE__*/function (_Component) {
  ...
  _createClass(ReactSortableTree, [{
    ...
    value: function getDerivedStateFromProps(_ref15, _ref16) {
      var treeData = _ref15.treeData,
          searchQuery = _ref15.searchQuery,
          searchFocusOffset = _ref15.searchFocusOffset,
          newInstanceProps = _ref15.instanceProps;
      var instanceProps = _ref16.instanceProps;
      return {
        instanceProps: _objectSpread2(_objectSpread2(_objectSpread2({}, instanceProps), newInstanceProps), {}, {
          treeData: treeData,
          searchQuery: searchQuery,
      ...
      walk({
        ...
        callback: function callback(_ref17) {
          var node = _ref17.node,
              path = _ref17.path,
              lowerSiblingCounts = _ref17.lowerSiblingCounts,
              treeIndex = _ref17.treeIndex;
...
var SortableTreeWithoutDndContext = function SortableTreeWithoutDndContext(props) {
  return /*#__PURE__*/React__default.createElement(reactDnd.DndContext.Consumer, null, function (_ref19) {
    var dragDropManager = _ref19.dragDropManager;
